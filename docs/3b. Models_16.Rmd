...
We'll fit a spatial error model based on the significant Robust LM (error).
...
### Main Effect
```{python}
sp_me = ps.model.spreg.GM_Error(y, me, w=w, name_y=y_name, name_x=me_ind, name_w='queens', name_ds='full_16.shp')
