---
title: "Models 2014 Election"
output: html_notebook
---

## Introduction
This notebook is one of a multiple part series for analyzing csb and voter data. This notebook accomplishes the building of the OLS and spatial models using the python library `pysal` and the R package `reticulate` to be able to execute python code in an R notebook.
...
name_w='queens', name_ds='full_14.shp')
...
### Full Model
```{python}
sp_fm = ps.model.spreg.GM_Lag(y, fm, w=w, name_y=y_name, name_x=fm_ind, name_w='queens', name_ds='full_14.shp')
